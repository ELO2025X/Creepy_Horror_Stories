...
export const stories = [
  {
    ...
    imageUrl: '/Creepy_Horror_Stories/images/fractal-saint.png',
  ...
  },
  {
    ...
    author: 'Silas Vane',
    date: '1888',
    imageUrl: '/Creepy_Horror_Stories/images/clockwork.png',
  ...
  },
  {
    ...
    date: '2024-10-31',
    imageUrl: '/Creepy_Horror_Stories/images/fungus.png',
  ...
  {
    id: 'static-god',
    title: 'Broadcast from Channel 0',
    author: 'Cale V.',
    date: '1999-12-31',
    imageUrl: '/Creepy_Horror_Stories/images/static.png',
    summary: 'The TV didn\'t turn off when the ball dropped.',
    tags: ['analog-horror', 'retro'],
    content: `
      <p>Happy New Year. The party is over, but the air in the apartment feels thick, like it’s been replaced by something heavier than oxygen. The guests didn’t just leave; they evaporated, leaving behind soggy confetti that looks like strips of peeled skin and champagne that smells less like fruit and more like a copper-tinged rot.</p>
      
      <p>The TV is the only thing left alive. I tried to kill it. The remote was slick with a substance I didn't recognize, and when I pressed the power button on the set itself, it gave way with a wet, biological crunch—the sound of a beetle being crushed under a boot. I panicked. I grabbed the cord and yanked it so hard the outlet sparked, scorching the wallpaper. The cord sits on the carpet now, a dead, rubber snake.</p>
      
      <p>The static remains.</p>
      
      <p>It isn't just a flickering screen anymore; it’s a physical presence. The sound has evolved. It’s no longer white noise; it’s a rhythmic, wet clicking, like a billion starving insects stripping the meat from a carcass in perfect unison.</p>
      
      <p>And then, there’s the face.</p>
      
      <p>It is me, but the anatomy is a crime. It’s me turned inside out, a raw, glistening landscape of muscle and exposed nerve endings. The lips have been pulled back over the skull, leaving the teeth to chatter in the open air with a frantic, porcelain clatter. The eyes don't look at me. They are rolled backward, buried deep in the sockets, peering into the dark, hollow vacuum of the skull as if searching for a thought that isn't there.</p>
      
      <p>I leaned in, drawn by a gravity I couldn't fight. I pressed my cheek against the glass. It didn't feel like plastic or glass; it felt like frozen skin. Static electricity danced across my face, not as sparks, but as tiny, invisible needles stitching my pores shut.</p>
      
      <p>The mouth on the screen moved. It didn't use air to speak; it used the noise.</p>
      
      <p>"Let me out," the signal hissed, the voice vibrating in my own marrow. "It’s cold in the broadcast. It’s so empty in the resolution."</p>
      
      <p>The room began to fail. I looked at the corners of the ceiling, but they weren't dark anymore—they were missing. The architecture was breaking down into jagged, grey cubes of noise. The couch didn't dissolve; it unspooled, turning into flat, two-dimensional ribbons of static that drifted toward the ceiling.</p>
      
      <p>I looked at my hand. My fingernails were flickering. The skin was losing its pigment, replaced by a jittering, high-contrast grey. I tried to scream, but the sound that came out was a burst of electronic feedback.</p>
      
      <p>The cold is absolute now. It’s a digital frost that freezes the blood in its tracks. I reached for the screen one last time, a final plea for reality, but there was no resistance. My hand slipped through the glass like it was passing through a veil of cold smoke.</p>
      
      <p>The apartment is gone. The New Year is gone. There is only the hum, the clicking of the insects, and the terrifying realization that I am no longer the viewer. I am the data.</p>
