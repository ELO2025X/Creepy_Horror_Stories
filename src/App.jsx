...
// Given the previous file had STORIES defined inline, I will keep it inline for now to avoid breaking data access, 
// BUT I will move it to a separate file in a future step ideally.
